          ...
          <div className="flex items-center justify-center h-full w-full">
            ...
            >
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <div className="text-xs text-zinc-500">PDF (upto 4MB)</div>
              </div>

              {acceptedFiles && acceptedFiles[0] ? (
                <div className="max-w-xs flex items-center bg-white rounded-md overflow-hidden outline outline-zinc-200 divide-x divide-zinc-200">
